...
const Landing = () => {
    ...
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-.3" className='w-full h-screen pt-1 bg-zinc-900'>
                        ...
                        <div className="flex items-center w-fit">
                            {index === 1 && (
                                <motion.div
                                    ...
                                    style={{ backgroundImage: "url('https://i.pinimg.com/originals/85/a0/a0/85a0a0d772ca6ea92fb672c780608e62.jpg')" }}
                                />
                            )}
            ...
            <div className='flex flex-col items-center justify-between px-4 py-4 mt-16 border-t-2 md:flex-row md:px-20 md:mt-32 border-zinc-700'>
                {["For public and private companies", "Design your Website"].map((item, index) => (
