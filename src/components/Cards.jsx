...
const Cards = () => {
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-0.1" className='flex w-full h-screen gap-5 p-10 mt-10 bg-zinc-900'>
            ...
            <div className='card mt-10 w-1/2 flex gap-5 h-[50vh]'>
                ...
                <div>⭐⭐⭐⭐⭐</div>
                <button className='absolute ml-9 px-6 py-2 border-2 text-[15px] rounded-3xl tracking-tight left-10 bottom-10 '>
